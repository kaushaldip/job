...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-6">
      <h3>Search results for zip code {{ $q }}</h3>
      <form action="{{ url('search') }}" method="get">
      <div class="row">
      <div class="col-md-9">
        <input type="text" name="q" value="{{ $q }}" class="form-control" placeholder="Enter Job title or Zip code" />
      </div>
      <div class="col-md-3">
      ...
      <div class="row" id="advance_option">
        <div class="col-md-6">
