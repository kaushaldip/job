                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="invoice-table table-responsive">
                                <table class="table">
                                    <thead><tr><th class="invoice-id">ID #</th><th>Job</th><th>Applied At</th><th>Actions</th></tr></thead>
                                    <tbody>
                                    ...
                                    @forelse (auth()->user()->applies as $apply)
                                        <tr>
                                            ...
                                            <td style="width: 200px;">
                                                ...
                                                {{-- <a href="{{ hospital_)url('/job/'.$apply->job->id.'/deactive') }}" class="btn btn-warning">Deactive</a> --}}
